...
//	public static final String PROPERTIES_TFS_URL = "tfs.system.1.url";
//	public static final String PROPERTIES_TFS_USER = "tfs.system.1.username";
//	public static final String PROPERTIES_TFS_PASSWORD = "tfs.system.1.password";
	
	public static final String IMAGE_TFS = "tfs.png"; //$NON-NLS-1$

	// The plug-in ID
	public static final String PLUGIN_ID = "com.collabnet.ccf.tfs";
	...
	private void initializeImages() {
		...
		createImageDescriptor(IMAGE_TFS);
	}
	
	protected void initializeImageRegistry(ImageRegistry reg) {
		super.initializeImageRegistry(reg);
		reg.put(IMAGE_TFS, getImageDescriptor(IMAGE_TFS));
	}
