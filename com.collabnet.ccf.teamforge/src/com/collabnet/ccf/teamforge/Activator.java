...
public class Activator extends AbstractUIPlugin {
	public static final String IMAGE_TEAM_FORGE = "ctfLogo.png"; //$NON-NLS-1$

	// The plug-in ID
	public static final String PLUGIN_ID = "com.collabnet.ccf.teamforge";
	...
	private void initializeImages() {
		...
		createImageDescriptor(IMAGE_TEAM_FORGE);
	}
	
	protected void initializeImageRegistry(ImageRegistry reg) {
		super.initializeImageRegistry(reg);
		reg.put(IMAGE_TEAM_FORGE, getImageDescriptor(IMAGE_TEAM_FORGE));
	}
